...
function submitAnswer() {
    ...
    if (window.location && typeof window.location.pathname === "string" && window.location.pathname.startsWith("/interview")) {
        const btn = document.getElementById("submitBtn") || document.querySelector("[data-submit-answer]");
        if (btn) btn.click();
        return;
    }
