...
# --- Security & production-friendly defaults (no UI changes) ---
...
logger = logging.getLogger("v10.app")
...
try:
    ...
    ai_service = None
    logger.exception("AI modules disabled (missing deps or provider not running).")
